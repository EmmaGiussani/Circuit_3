/*
c++ -o fitRL_R fitRL_R.cpp `root-config --cflags --glibs`
*/
...
int main(int argc, char** argv)
{
  ...
  TF1* myFun = new TF1 ("myFun","[0]/(39+[0])*sqrt((1+(2*3.14*x*[2])^2)/((1+(2*3.14*x*([1]/(39+[0])))^2)*(1+(2*3.14*x*[3])^2)))");
  ...
  myFun->SetParameter(2,0.00008);
  myFun->SetParameter(3,0.00005);
